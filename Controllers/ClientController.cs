...
// regiseer case===============================================================================
        ...
        [HttpPost]
        public ActionResult upload(HttpPostedFileBase files, caseinfo ob)
        {
            try
            {
                if (files.ContentLength > 0)
                {
                    ...
                    common sql = new common();
                    int c = sql.Execute("insert into Cases values('" + Session["cid"].ToString() + "','" + Session["Cname"].ToString() + "','" + ob.advid + "','" + ob.advname + "','" + ob.category + "','" + ob.court + "','" + ob.description + "','" + ob.fee + "','" + System.DateTime.Now.ToShortDateString() + "','Registred','','','" + Session["climg"].ToString() + "','" + ob.advimg + "','" + path1 + "')");
                ...
                {
                    return RedirectToAction("regcase", "Client");
                }
